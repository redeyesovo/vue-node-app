<template>
    <div class="fillContainer">
        ...
        <DialogPlat :dialog='dialog' :formData='formData' @update="getPlat"></DialogPlat>
    </div>
</template>

<script>
    import DialogPlat from "../components/DialogPlat";
    export default {
        name: "PlatManage",
        data() {
            return {
        ...
        methods:{
            ...
            handleDelete(index,row){
                //console.log(456);
                // 删除
                this.$axios.delete(`/api/plats/delete/${row._id}`).then(res => {
                    this.$message("删除成功");
                    this.getPlat();
                });
            },
