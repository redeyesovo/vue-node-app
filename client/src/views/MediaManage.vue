    ...
    <div class="fillContainer">
        ...
        <div class="table_container">
            ...
            >
                ...
                <el-table-column
                        prop="mediaid" label="媒介id" width="200" align="center"
                ></el-table-column>
                <el-table-column
                        prop="medianame" label="媒介名称" width="200" align="center"
                ></el-table-column>
                <el-table-column
        ...
        <DialogMedia :dialog='dialog' :formData='formData' @update="getMedia"></DialogMedia>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            getMedia() {
                // 获取表格数据
                this.$axios("/api/medias").then(res => {
            ...
            handleDelete(index,row){
                //console.log(456);
                // 删除
                this.$axios.delete(`/api/medias/delete/${row._id}`).then(res => {
                    this.$message("删除成功");
                    this.getMedia();
                });
            },
